...
const GLSLHills: React.FC<GLSLHillsProps> = ({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // Cap at 1.5 — background mesh, sub-pixel difference is invisible
    ...
    const startLoop = () => {
      ...
      clock.getDelta(); // flush time accumulated while paused
      loop();
    };
    ...
    // Stop rendering when the hero is scrolled off screen
